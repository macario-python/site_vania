...
async function carregarPublicacoes() {
  ...
  try {
    ...
    listaDiv.innerHTML = dados.map(function (p, i) {
      var imgHtml = p.imagem_path
        ? '<div class="publicacao-card-img" style="background-image:url(\'' + urlImagemPublicacao(p.imagem_path) + '\')"></div>'
        : '<div class="publicacao-card-img"></div>';
...
function abrirModalPublicacao(p) {
  ...
  imgWrap.innerHTML = p.imagem_path ? '<img src="' + urlImagemPublicacao(p.imagem_path) + '" alt="">' : '';
